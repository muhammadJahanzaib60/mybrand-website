    ...
    <main>
      ...
      <section style={{padding:"100px 6%", background:"linear-gradient(135deg,#0F172A,#1E293B)", color:"#fff"}}>
        <div style={{maxWidth:"1200px", margin:"auto"}}>
          <div style={{display:"inline-block", padding:"6px 14px", background:"rgba(245,158,11,0.15)", color:"#F59E0B", borderRadius:"20px", fontSize:"12px", fontWeight:700}}>DGK GROWTH AGENCY</div>
